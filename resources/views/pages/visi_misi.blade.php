                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2">
                                            <img src="{{ asset('/') }}storage/{{ $dataItem->item_file ?? '' }}" alt="simulasi" class="img-thumbnail simulasi-gambar-picture-visi-misi" width="140px">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <table id="side-list-visi-misi" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="{{ route('edit-visi-misi',  ['id' => base64_encode($dm->id)])}}" class="btn btn-warning">Edit</a>
