    ...
    <section class="content p-4 col-md-12" >
        <div class="card card-default">
            <div class="card-header bg-red">
                <h3 class="card-title">Create Job Vacancy</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1"> </div>
                                        <div class="col-md-9">
                                            <textarea class="form-control desc" name="jobdescripsi" id="jobdescripsi" rows="4" cols="50"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                           ...
                                           <div class="col-md-1"> </div>
                                           <div class="col-md-9">
                                               <textarea class="form-control desc" name="skillRequirement" id="skillRequirement" rows="4" cols="50"></textarea>
                                           </div>
                                    </div>
                                    <div class="form-group row">
